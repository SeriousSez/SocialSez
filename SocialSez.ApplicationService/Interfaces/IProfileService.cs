...
public interface IProfileService
{
    ...
    Task<EngagementStreakDto?> GetEngagementStreakAsync(Guid profileId, CancellationToken cancellationToken = default);
    Task<EngagementStreakDto?> TrackEngagementAsync(Guid profileId, TrackEngagementStreakRequest request, CancellationToken cancellationToken = default);
