...
public interface IProfileService
{
    ...
    Task<ProfileDto?> GetByHandleAsync(string handle, CancellationToken cancellationToken = default);
    Task<IReadOnlyCollection<ProfileDto>> SearchAsync(string query, int take = 20, CancellationToken cancellationToken = default);
