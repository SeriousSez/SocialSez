...
public interface IChatService
{
    ...
    Task<ChatConversationDto?> UpdateGroupConversationTitleAsync(Guid profileId, Guid conversationId, UpdateGroupConversationTitleRequest request, CancellationToken cancellationToken = default);
    Task<bool> LeaveGroupConversationAsync(Guid profileId, Guid conversationId, CancellationToken cancellationToken = default);
    Task<ChatConversationDto?> SetConversationMuteAsync(Guid profileId, Guid conversationId, SetConversationMuteRequest request, CancellationToken cancellationToken = default);
